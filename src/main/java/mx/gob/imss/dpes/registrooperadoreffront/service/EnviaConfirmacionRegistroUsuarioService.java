...
import mx.gob.imss.dpes.registrooperadoreffront.restclient.EnviaCorreoClient;
 ...
 */
@Provider
public class EnviaConfirmacionRegistroUsuarioService extends ServiceDefinition<ActivarRegistroRequest, ActivarRegistroRequest> {
    ...
    public Message<ActivarRegistroRequest> execute(Message<ActivarRegistroRequest> request) throws BusinessException {
        String cuerpoCorreo = config.getValue("plantillaCorreoActivacion", String.class);
        
        CorreoSinAdjuntos correo = new CorreoSinAdjuntos();
        correo.setAsunto("Activación Exitosa");
